...
#[derive(Debug)]
pub struct NeoOpticalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoOpticalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoOptical processing");
    
    let mut processor = NeoOpticalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoOpticalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoOpticalProcessor::new(false);
